...
void sort(studsqlist p)
{
	...
	for(i=0;i<p.s_num;i++)
	{
		...
		printf("%d ",p.sum_score[i]);
	}
	printf("\n");
	print(p);
	for(i=0;i<p.s_num-1;i++)
	{
...
void menu()
{
	...
	while(1)
	{
		switch(menu_select())
		{
			...
			case 5:insert(&s);system("pause");system("cls");break;
			case 6:del(&s);system("cls");break;
			case 7:sort(s);system("pause");system("cls");break;
			case 8:exit(1);
		}
	}
}
